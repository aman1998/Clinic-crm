...
export function TableMedications({ initialList, onChange, readOnly, isEdit }) {
	...
	const isDisabledEditButton = !form.days || !form.medicament || !form.instruction;
	...
	return (
		<>
			<div>
				<div className="xs1:grid xs1:grid-cols-2 gap-10  mb-10">
					<TextField
						label="Медикамент"
						variant="outlined"
						fullWidth
				...
				<div className="gap-10 xs1:grid xs1:grid-cols-2">
					<TextField
						label="Инструкция"
						variant="outlined"
						fullWidth

...
export function ModalConfirmReworkWarehouse({ workShiftUuid, isOpen, onClose }) {
	...
	const reworkReport = useMutation(({ uuid, data }) => employeesService.reworkWarehouseDoctorWorkShift(uuid, data));
	const handleRework = () => {
		clearErrors();
...
ModalConfirmReworkWarehouse.propTypes = {

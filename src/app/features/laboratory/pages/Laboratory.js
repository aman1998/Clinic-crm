...
const tabConfig = [
	{
		label: 'Приёмы',
		url: '/laboratory',
		auth: [PERMISSION.LABORATORY.VIEW_LABORATORY_RECEPTION]
	},
	{
		label: 'Склад',
		url: '/laboratory/warehouse',
		auth: [PERMISSION.LABORATORY.VIEW_WAREHOUSE]
	}
];

export default function Laboratory({ route }) {
	const [menu, setMenu] = useState(null);

	useToolbarTitle('Лаборатория');

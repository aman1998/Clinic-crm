	...
	return (
		<div className={classes.root}>
			<div className={clsx(classes.panel, { opened: state }, 'flex flex-col')} ref={ref}>
				<AppBar position="static" elevation={1} style={{ backgroundColor: theme.palette.background.default }}>
					<Toolbar className="px-4">
						{(!state || !selectedContactId) && (
							<div className="flex flex-1 items-center px-4">
								<IconButton className="text-black" onClick={ev => dispatch(Actions.openChatPanel())}>
